...
This skill is published in the `itsfedor/esl-automation-suite` suite
(repo layout: `skills/<skill-name>/SKILL.md`). After an update, push the
change and verify with the contents API — confirm the file list and sizes,
not just the push exit code.
